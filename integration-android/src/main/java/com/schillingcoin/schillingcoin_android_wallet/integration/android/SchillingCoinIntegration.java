...
package com.schillingcoin.schillingcoin_android_wallet.integration.android;
...
public final class SchillingCoinIntegration
{
	...
	{
		final Intent intent = makeURIIntent(address, null);
	...
	{
		final Intent intent = makeURIIntent(address, amount);
