...
package com.schillingcoin.schillingcoin_android_wallet.util;
...
import com.schillingcoin.schillingcoinj.core.TransactionInput;
import com.schillingcoin.schillingcoinj.core.TransactionOutput;
...
import com.schillingcoin.schillingcoinj.wallet.KeyChainGroup;
...
public class WalletUtils
{
	...
	public static void writeKeys(@Nonnull final Writer out, @Nonnull final List<ECKey> keys) throws IOException
	{
		...
		out.write("# KEEP YOUR PRIVATE KEYS SAFE! Anyone who can read this can spend your SchillingCoins.\n");
