...
import com.schillingcoin.schillingcoin_android_wallet.service.BlockchainState;
import com.schillingcoin.schillingcoin_android_wallet.service.BlockchainStateLoader;
...
public final class ExchangeRatesFragment extends FancyListFragment implements OnSharedPreferenceChangeListener
{
	...
	{
		if (Configuration.PREFS_KEY_EXCHANGE_CURRENCY.equals(key) || Configuration.PREFS_KEY_OES_PRECISION.equals(key))
		{
			defaultCurrency = config.getExchangeCurrencyCode();
