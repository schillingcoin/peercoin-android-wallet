...
import com.schillingcoin.schillingcoin_android_wallet.ui.preference.PreferenceActivity;
import com.schillingcoin.schillingcoin_android_wallet.ui.send.SendCoinsActivity;
import com.schillingcoin.schillingcoin_android_wallet.util.CrashReporter;
import com.schillingcoin.schillingcoin_android_wallet.util.Crypto;
import com.schillingcoin.schillingcoin_android_wallet.util.HttpGetThread;
import com.schillingcoin.schillingcoin_android_wallet.util.Iso8601Format;
...
import com.schillingcoin.schillingcoin_android_wallet.util.WholeStringBuilder;
import com.schillingcoin.schillingcoin_android_wallet.R;
import com.schillingcoin.schillingcoin_android_wallet.ui.RestoreWalletTask.CloseAction;
...
//                return true;
    ...
    public void handleExportTransactions() {
        ...
        try {
            ...
            writer.append("Date,Label,Amount (" + MonetaryFormat.CODE_OES + "),Fee (" + MonetaryFormat.CODE_OES + "),Address,Transaction Hash,Confirmations\n");
	...
	private void prepareRestoreWalletDialog(final Dialog dialog)
	{
		...
		if (Constants.Files.EXTERNAL_WALLET_BACKUP_DIR.exists() && Constants.Files.EXTERNAL_WALLET_BACKUP_DIR.isDirectory())
			for (final File file : Constants.Files.EXTERNAL_WALLET_BACKUP_DIR.listFiles()) {
				...
				if (!file.getName().contains("Schillingcoin"))
					continue;
	...
	{
		if(Constants.VERSION_URL == null || Constants.VERSION_URL.trim().length() == 0)
			return;
