...
package com.schillingcoin.schillingcoin_android_wallet.data;
...
import com.schillingcoin.schillingcoinj.core.ScriptException;
import com.schillingcoin.schillingcoinj.core.Transaction;
import com.schillingcoin.schillingcoinj.core.Wallet.SendRequest;
import com.schillingcoin.schillingcoinj.core.WrongNetworkException;
...
import com.schillingcoin.schillingcoinj.script.Script;
...
import com.schillingcoin.schillingcoin_android_wallet.util.GenericUtils;
import com.schillingcoin.schillingcoinj.params.Networks;
...
public final class PaymentIntent implements Parcelable {
    ...
    public static PaymentIntent fromURI(@Nonnull final SchillingcoinURI SchillingcoinURI) {
        final Address address = SchillingcoinURI.getAddress();
        final Output[] outputs = address != null ? buildSimplePayTo(SchillingcoinURI.getAmount(), address) : null;
        final String bluetoothMac = (String) SchillingcoinURI.getParameterByName(Bluetooth.MAC_URI_PARAM);
        final String paymentRequestHashStr = (String) SchillingcoinURI.getParameterByName("h");
        final byte[] paymentRequestHash = paymentRequestHashStr != null ? base64UrlDecode(paymentRequestHashStr) : null;

        return new PaymentIntent(PaymentIntent.Standard.BIP21, null, null, outputs, SchillingcoinURI.getLabel(), bluetoothMac != null ? "bt:"
        + bluetoothMac : null, null, SchillingcoinURI.getPaymentRequestUrl(), paymentRequestHash, address.getParameters());
    }
        ...
        if (i != -1) {
            ...
            if (coin != null) {
                try {
                    ...
                    SchillingcoinURI uri = new SchillingcoinURI(coin, input, coin.getId());
                    return PaymentIntent.fromURI(uri);
                } catch (SchillingcoinURIParseException ex) {
                }
            }
        }
